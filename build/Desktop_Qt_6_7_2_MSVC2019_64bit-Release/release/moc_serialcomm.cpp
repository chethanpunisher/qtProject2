...
struct qt_meta_stringdata_CLASSSerialCommENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSerialCommENDCLASS = QtMocHelpers::stringData(
    "SerialComm",
    "dataReceived",
    "",
    "data",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSerialCommENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SerialComm::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSerialCommENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSerialCommENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSerialCommENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SerialComm, std::true_type>,
        // method 'dataReceived'
...
void SerialComm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SerialComm::*)(const QString & );
            if (_t _q_method = &SerialComm::dataReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialComm::*)(const QString & );
            if (_t _q_method = &SerialComm::errorOccurred; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *SerialComm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSerialCommENDCLASS.stringdata0))
...
// SIGNAL 0
void SerialComm::dataReceived(const QString & _t1)
{
