...
struct qt_meta_stringdata_CLASSExcelHandlerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSExcelHandlerENDCLASS = QtMocHelpers::stringData(
    "ExcelHandler"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSExcelHandlerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ExcelHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSExcelHandlerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSExcelHandlerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSExcelHandlerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ExcelHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSExcelHandlerENDCLASS.stringdata0))
